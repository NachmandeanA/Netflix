...
public class Main {
    ...
    private static ListOfSeries listOfSerials = new ListOfSeries();
    ...
    public static void main(String[] args) {
        ...
        user1.setPassword("ok8709");

        User user2 = new User();
        user2.setUserName("rivaldo");
        user2.setPassword("56777rfr");
        ...
        listOfSerials.addToList(s3);
        listOfSerials.addToList(s4);
    ...
    public static void JoinToAccount() {
        ...
        if (!IsAlreadyTaken(nickname)) {
            System.out.println("No account with this nickname");
            MainMenu();
        }
    ...
    public static void UserActivity() {
        ...
        System.out.println("2 - Show series I already saw");
    ...
    public static void ShowAllSeries() {
        for (Series series2 : listOfSerials.getListOfSeries()) {
            System.out.println("Name of Series: " + series2.getName());
        }
        UserActivity();
    }
    ...
    public static void SelectSeriesToWatch() {//not final
        ...
        for (Series series2 : listOfSerials.getListOfSeries()) {//not final
            System.out.println(series2.getName());
