...
public class User {
    ...
    private ListOfSeries finishedSeries;
    private ListOfSeries startedSeries;
    private ListOfSeries allSeries;
    ...
    public User() {
        ...
        finishedSeries = new ListOfSeries();
        startedSeries = new ListOfSeries();
        allSeries = new ListOfSeries();
    ...
    public Series[] getFinishedSeries() {
        return finishedSeries.getListOfSeries();
    }

    public void setFinishedSeries(Series[] finishedSeries) {
        this.finishedSeries.setListOfSeries(finishedSeries);
    }

    public Series[] getStartedSeries() {
        return startedSeries.getListOfSeries();
    }

    public void setStartedSeries(Series[] startedSeries) {
        this.startedSeries.setListOfSeries(startedSeries);
    }

    public Series[] getAllSeries() {
        return allSeries.getListOfSeries();
    }

    public void setAllSeries(Series[] allSeries) {
        this.allSeries.setListOfSeries(allSeries);
    }
    ...
    public boolean isSerialStartedWatching(String nameOfSerial) {
        try {
            for (Series series : startedSeries.getListOfSeries()) {
